...
def mainA1():
    """
    Prepare the pg_rl of all tasks for mainA.
    :return:
    """
    start_time = time.time()
...
def mainC1():
    ...
    with open('PlanC1_training_values.pkl', 'wb') as f:
...
def mainC2():
    ...
    with open('PlanC2_regular_values.pkl', 'wb') as f:
        pickle.dump(regular_values, f)


def mainC3():
    """
    This function is used to plot and compare results of pg-rlla and regular pg_rl.
    :return:
    """
    with open('PlanC1_training_values.pkl', 'rb') as f:
        values_pg_rl, values_pg_ella, model = pickle.load(f)

    with open('PlanC2_regular_values.pkl', 'rb') as f:
...
def testing():
    ...
    with open('PlanA_learned_values_model.pkl', 'rb') as f:
        learned_values, model = pickle.load(f)
