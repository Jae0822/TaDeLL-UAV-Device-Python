...
#  field: 1 km * 1km
#  dist:
param = {'nTimeUnits': 30, 'num_Devices': 3, 'V': 72, 'field': 1, 'dist': 0.040, 'freq_low': 8, 'freq_high': 16}
Devices = []
...
def main():
    ...
    for i_episode in count(1):
        ...
        # while t <= param['nTimeUnits']:
            ...
            state, reward, t = env.step(state, action, t)
            n += 1
            ...
            print("The {} episode" " and the {} fly" " at the {} time slots. " "Visit device {}".format(i_episode, n, t, action))
            print("----------------------------------------------------------------------------")
        #  Average Reward
