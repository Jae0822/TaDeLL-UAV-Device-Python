...
xlabel('UAV Velocity (km/h)', 'Fontsize',16)
ylabel('Average AoI and Reward', 'Fontsize',16)
% title('Performance of Devices')

yyaxis right
plot(x_axis, UAV_CPU_J, 'K*-','DisplayName','CPU of Devices', 'LineWidth', 3, 'MarkerSize',10) % 'Color', colorMat(3,:))
ylabel('Devices Energy Consumption (mJ)', 'Fontsize',16)
...
x_axis = 10:5:40;
yyaxis left
bar(x_axis, UAV_Energy,'DisplayName','Energy of UAV')
xlabel('UAV Velocity (km/h)', 'Fontsize',16)
ylabel('Average Reward and Energy', 'Fontsize',16)
% title('Performance of UAV')
xlim([6,44])
ylim([0, 8])

yyaxis right
plot(x_axis, UAV_Reward, 'o-', 'DisplayName','Reward of UAV', 'LineWidth', 2,'Color', colorMat(7,:)); 
plot(x_axis, UAV_Reward_Random, '^-', 'DisplayName','Random Reward of UAV', 'LineWidth', 2,'Color', colorMat(5,:)); 
plot(x_axis, UAV_Reward_Force, '*-', 'DisplayName','Force Reward of UAV', 'LineWidth', 2,'Color', colorMat(3,:)); 
...
ylabel('UAV Energy (mJ)', 'Fontsize',16)
