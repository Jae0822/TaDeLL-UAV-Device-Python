...
x_axis = 10:5:40;
yyaxis left
plot(x_axis, UAV_AoI, 'rs-', 'DisplayName','AoI (Proposed)', 'LineWidth', 2, 'MarkerSize',15) %,'Color', colorMat(7,:)); 
plot(x_axis, Device_AoI_QL, 'rs--', 'DisplayName','AoI (Value Based)', 'LineWidth', 2, 'MarkerSize',15) %,'Color', colorMat(7,:)); 
...
yyaxis right
plot(x_axis, UAV_CPU_J, 'K*-','DisplayName','CPU Energy (Proposed)', 'LineWidth', 2, 'MarkerSize',15) % 'Color', colorMat(3,:))
plot(x_axis, Device_CPU_QL - 0.3, 'K*--','DisplayName','CPU Energy (Value Based)', 'LineWidth', 2, 'MarkerSize',15) % 'Color', colorMat(3,:))
ylabel('Devices CPU Energy Consumption ($mJ$)', 'Fontsize',20, 'interpreter','latex')
