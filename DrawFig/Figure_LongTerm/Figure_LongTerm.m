...
xlabel('Number of Time Slots', 'FontSize', 16)
ylabel('Average Reward of Devices', 'FontSize', 16)

annotation('textarrow',[0.2,0.15],[0.25,0.4],'String','Environment 1 ', 'FontSize', 12)
annotation('textarrow',[0.4,0.32],[0.3,0.2],'String','Environment 2 ', 'FontSize', 12)
annotation('textarrow',[0.68,0.62],[0.55,0.7],'String','Environment 3 ', 'FontSize', 12)
annotation('textarrow',[0.8,0.75],[0.3,0.48],'String','Environment 4 ', 'FontSize', 12)
